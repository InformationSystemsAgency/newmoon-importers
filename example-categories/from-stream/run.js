/**
 * Import categories from CSV via the **from-stream** pipeline (`../data/categories.etl.csv`).
 * Same batched streaming extract/transform/load as `from-csv`, separate entry folder.
 *
...
async function main() {
  console.log('📥 Extract: streamed CSV — from-stream runner (batched)\n');
